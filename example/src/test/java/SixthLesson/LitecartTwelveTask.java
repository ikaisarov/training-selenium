...
public class LitecartTwelveTask {
    ...
    public void additionsGoods(){
        ...
        driver.findElement(By.cssSelector("#tab-general [name=code]")).sendKeys("555");
        ...
        File image = new File("src/test/java/SixthLesson/Duck.jpg");
        ...
        WebElement manu = driver.findElement(By.cssSelector("[name=manufacturer_id]"));
        actions.click(manu).sendKeys(Keys.DOWN).sendKeys(Keys.ENTER).release().perform();

        driver.findElement(By.cssSelector("[name='keywords']")).sendKeys("Test");
        driver.findElement(By.cssSelector("[name='short_description[en]']")).sendKeys("Test Description");
        driver.findElement(By.cssSelector(".trumbowyg-editor")).sendKeys("Main Description");
